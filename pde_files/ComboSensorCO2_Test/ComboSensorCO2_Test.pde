...
int tempSensorPin = 0;    // select the input pin for the data line on the sensor 
int rhSensorPin = 1;
...
const int POLLING_DELAY = 60000; //the polling interval in miliseconds
...
void loop() {  
  ...
  **/
  ...
  if((currentMillis - pm1) > BLINK_DELAY) {
