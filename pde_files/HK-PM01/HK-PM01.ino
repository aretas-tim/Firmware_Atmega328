...
void parseBuffer(byte buffer[]) {
  ...
  */
  ...
  //Serial.print("PM 1.0 BUF [0x"); Serial.print(hi, HEX); Serial.print(",0x"); Serial.print(lo, HEX); Serial.print("] RES: ["); Serial.print(result); Serial.print("]"); Serial.println();
  ...
  //Serial.print("PM 2.5 BUF [0x"); Serial.print(hi, HEX); Serial.print(",0x"); Serial.print(lo, HEX); Serial.print("] RES: [");  Serial.print(result); Serial.print("]"); Serial.println();
  ...
  //Serial.print("PM 10 BUF [0x"); Serial.print(hi, HEX); Serial.print(",0x"); Serial.print(lo, HEX); Serial.print("] RES: ["); Serial.print(result); Serial.print("]"); Serial.println();
  Serial.println();
